...
export interface paths {
  ...
  "/tailnet/{tailnet}/logging/configuration": {
    ...
    parameters: {
      ...
      query: {
        /** The start of the time window for which to retrieve logs, in RFC 3339 format. */
        start: components["parameters"]["start"];
        /** The end of the time window for which to retrieve logs, in RFC 3339 format. */
        end: components["parameters"]["end"];
        /** List of filters on actors, either exact actor IDs or a wildcard search on login name or display name indicated as `~search`. */
        actor?: components["parameters"]["actor"];
        /** List of target elements for which to filter, attempts to match any part of any of the targets to any of the given strings. */
        target?: components["parameters"]["target"];
        /** List of events for which to filter. */
  ...
  "/tailnet/{tailnet}/aws-external-id": {
     ...
     * OAuth Scope: `log_streaming`.
     */
    post: operations["getAwsExternalId"];
    parameters: {
      path: {
        /**
         * The tailnet organization name.
  ...
  "/tailnet/{tailnet}/aws-external-id/{id}/validate-aws-trust-policy": {
     ...
     * OAuth Scope: `log_streaming`.
     */
    post: operations["validateAwsExternalId"];
    parameters: {
      path: {
        /**
         * The tailnet organization name.
         ...
         */
        tailnet: components["parameters"]["tailnet"];
        /** The AWS external ID to validate. */
        id: string;
      };
    };
  };
  ...
  "/tailnet/{tailnet}/keys": {
    ...
    parameters: {
      ...
      query: {
        /** If set to true, this will return all auth keys, API acess tokens and OAuth clients for the tailnet. */
  ...
  "/posture/integrations/{id}": {
    ...
    parameters: {
      path: {
        /** Unique identifier for a posture integration. */
  ...
  "/tailnet/{tailnet}/settings": {
     ...
     *
     * OAuth Scope: `feature_settings:read` - required to view all settings except those goverened by the below scopes.
     *
     ...
     *
     * OAuth Scope: `feature_settings` - required to update all settings except those goverened by the below scopes.
     *
     * OAuth Scope: `logs:network` - required to view the `networkFlowLoggingOn` setting.
     */
...
export interface components {
  schemas: {
     ...
     * }
     */
    SplitDns: { [key: string]: string[] | null };
...
export interface operations {
  ...
  listNetworkFlowLogs: {
    ...
    responses: {
      /** Successful operation. The `logs` field contains an array of [NetworkFlowLog](#model/networkflowlog) objects. */
      200: {
        content: {
          "application/json": {
            /** @description Matching log entries, ordered chronologically. */
  ...
  getAwsExternalId: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["AwsExternalId"];
        };
      };
  ...
  validateAwsExternalId: {
    ...
    responses: {
      /** Validation succeeded for this external ID and IAM role. */
      200: unknown;
      /** User does not have sufficient access for this tailnet. */
      403: components["responses"]["403"];
      /** Tailnet or external ID not found. */
      404: components["responses"]["404"];
      /** Validation failed for this external ID and IAM role. */
      422: {
        content: {
          "application/json": {
  ...
  previewRuleMatches: {
    ...
    responses: {
      /** The list of rules that apply to the resource. */
      200: {
        content: {
          "application/json": {
            matches: {
  ...
  validateAndTestPolicyFile: {
    ...
    responses: {
      /** Validation or tests have run. An empty response body implies passing validation or tests. */
      200: {
        content: {
          "application/json": {
      ...
      content: {
        "application/json":
          | {
             ...
             * }
             */
            srcPostureAttrs?: { [key: string]: string | number | boolean };
            /**
  ...
  testWebhook: {
    ...
    responses: {
      /** Successfully queued test event. */
      202: unknown;
      400: components["responses"]["400"];
      403: components["responses"]["403"];
      /** User not found. */
